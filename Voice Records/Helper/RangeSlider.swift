...
class RangeSliderThumbLayer: UIView {
...
//    }
    ...
    override func awakeFromNib() {
        ...
        let img = UIImageView(frame: CGRect(x: 0, y: 0, width: self.Getwidth, height: self.GetHeight))
        img.image = UIImage(named: "ic_thumb")
        self.addSubview(img)
    }
}
...
//        lowerThumbLayer.contentsScale = UIScreen.main.scale
        self.addSubview(lowerThumbLayer)
//        layer.addSublayer(lowerThumbLayer)
      
      
        upperThumbLayer.rangeSlider = self
//        upperThumbLayer.contentsScale = UIScreen.main.scale
        self.addSubview(upperThumbLayer)
//        layer.addSublayer(upperThumbLayer)
    ...
    func updateLayerFrames() {
        ...
        lowerThumbLayer.frame = CGRect(x: lowerThumbCenter - thumbWidth/2.0, y: 0, width: thumbWidth, height: self.GetHeight)
        
        lowerThumbLayer.setNeedsDisplay()
        
        let upperThumbCenter = CGFloat(positionForValue(upperValue))
        upperThumbLayer.frame = CGRect(x: upperThumbCenter - thumbWidth/2.0, y: 0, width: thumbWidth, height: self.GetHeight)
        upperThumbLayer.setNeedsDisplay()
